...
[![Version](https://img.shields.io/badge/version-v3.5-blue)](https://github.com/CasterYu/dashboard)
...
| 版本 | 链接 | 状态 | 说明 |
|:---:|:---|:---:|:---|
| **🟢 v3.5 · 最新版** | **👉 [https://casteryu.github.io/dashboard/](https://casteryu.github.io/dashboard/)** | ✅ 当前 | 六级组织树筛选（全国→大区→小区→门店→岗位→人员）+ 单选 / PK 双模式 + 全链路 7 阶段漏斗（带转化率徽章）+ 三大板块可展开按日走势折线图 + **经营结果趋势分析（指标多选、双 Y 轴、阶段转化率）** + 多维下钻 + 积分榜 + 明细表 |
...
| 版本 | 文件路径 |
|:---:|:---|
| **v3.5 最新版** | `D:\projects\dashboard\index.html` |
...
- **v3.5（当前）**：底部「经营结果趋势分析」改为**指标多选折线图**：默认显示「意向线索 / 到店 / 锁单」3 条曲线，可在 10 项指标中任选最多 4 项；绝对量指标（线索、到店、锁单等）使用左侧 Y 轴，阶段转化率（意向线索→到店、到店→试驾、试驾→锁单）使用右侧百分比 Y 轴；悬停时统一展示该日期下全部选中指标的具体数值与百分比。三大板块展开折线图保留原有交互。
...
[👉 v3.5 最新版](https://casteryu.github.io/dashboard/) · [👉 v1 历史版](https://casteryu.github.io/dashboard/legacy/v1/)
